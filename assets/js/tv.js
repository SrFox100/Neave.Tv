    ...
    var TV = (function() {
        ...
        function drawVideo() {
            ...
            if (videoLoading) {
                ...
                testcardMod %= 3;
                if (testcardMod === 0) {
                    var imageData = testcardContext.getImageData(0, 0, testcardCanvas.width, testcardCanvas.height), pixels = imageData.data, length = pixels.length, offset, i = 0, x, y;
